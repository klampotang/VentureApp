...
class SettingsViewController: UIViewController, CitiesViewControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func initializeCircularSlider() {
        let circularSlider = EFCircularSlider(frame: CGRectMake(200, 190, 100, 100))
    ...
    override func viewDidLoad() {
        ...
        staticCityLabel.font = UIFont(name: "HelveticaNeue-Thin", size: 13)
        staticRadiusLabel.font = UIFont(name: "HelveticaNeue-Thin", size: 13)
