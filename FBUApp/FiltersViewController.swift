...
class FiltersViewController: UIViewController, UINavigationControllerDelegate, LocationsViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        uploadButton.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 11)
        locationTextField.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 14)
        button1.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        button2.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        buton3.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        button4.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        button5.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        button6.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        button7.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        button8.titleLabel!.font = UIFont (name: "BodoniSvtyTwoSCITCTT-Book", size: 13)
        self.logAllFilters()
    }
